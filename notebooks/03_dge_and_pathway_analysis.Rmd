...
For each selected program, I calculate a sample-level pathway score within the relevant target cell type and test whether it differs across PAM50 subtypes after accounting for batch.
